<?php
$sql_sua_baiviet = "SELECT * FROM tbl_baiviet WHERE baiviet_id='$_GET[idbaiviet]' LIMIT 1" ;
...
<table border="1" width="100%" style="border-collapse: collapse;"> 
    ...
    ?> 
    <form method="POST" action="modules/quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['baiviet_id'] ?>" enctype="multipart/form-data">         
    <tr>
        <td>Tên Bài Viết </td>
